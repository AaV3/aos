...
\par In the following figures \ref{fig:first_game_run} and \ref{fig:second_game_run} is a sample run of the game logic at starting a new game with pressing the push button after the first game has concluded.
