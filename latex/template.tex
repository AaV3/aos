...
\horrule{0.5pt} \\[0.4cm]
\huge \textbf{AOS Microcontroller Project} \\[.5cm] % The assignment title
\large [ Light Sensor \& ADC Interfacing ] \\ % Pick one: Monography and Coding Project
\horrule{2pt} \\[0.5cm]
\vfill
\author{}
\begin{tabular}{r l}
\textbf{Student} & Christian M\"uller \& Arno Virtanen \\
\textbf{ID} & 894942 \& 894986 \\[0.5cm]
